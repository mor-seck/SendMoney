...
// Returns the private 'App\Repository\CompteBancaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CompteBancaireRepository.php';

return $this->privates['App\\Repository\\CompteBancaireRepository'] = new \App\Repository\CompteBancaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
